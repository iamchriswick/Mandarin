				...
				<ul>
					...
					<li class="<?php echo $col_class; ?>">
						...
						<div class="about_listing_txt">
							<?php echo apply_filters( 'the_content', get_theme_option('about_col_1') ); ?>
						</div>
					...
					<li class="<?php echo $col_class; ?>">
						...
						<!-- Column content -->
						<div class="about_listing_txt">
							<?php echo apply_filters( 'the_content', get_theme_option('about_col_2') ); ?>
						</div>
					...
					<li class="<?php echo $col_class; ?>">
						...
						<!-- Column content -->
						<div class="about_listing_txt">
							<?php echo apply_filters( 'the_content', get_theme_option('about_col_3') ); ?>
						</div>
					...
					<li class="<?php echo $col_class; ?>">
						...
						<!-- Column content -->
						<div class="about_listing_txt">
							<?php echo apply_filters( 'the_content', get_theme_option('about_col_4') ); ?>
						</div>
